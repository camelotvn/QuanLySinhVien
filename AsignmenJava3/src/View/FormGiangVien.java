 ...
 * @author Vinh
 */
public final class FormGiangVien extends javax.swing.JFrame {
      
        private PanelDashboash pd;
        private PanelHelp pnhelp;
        private  Account acc;
    public FormGiangVien(String user) {
        initComponents();
        ...
        pd = new PanelDashboash();
        pnhelp = new  PanelHelp();
        acc = new Account(user);
        showDashboash();
        UserLogin.setText("User: "+user);
        showdate();
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(boder1, javax.swing.GroupLayout.PREFERRED_SIZE, 562, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormGiangVien("Not Login").setVisible(true);
            }
        });
    }
